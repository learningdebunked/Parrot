...
/**
 * @author Kapil
 * @created 09/06/2020 - 5:17 PM
 * @project mock
 */
public class MockAppError {

    private final String apiVersion;
    private final ErrorBlock error;

    public MockAppError(final String apiVersion, final String code, final String message, final String domain,
    ...
    public static MockAppError fromDefaultAttributeMap(final String apiVersion,
